...
def ternary_search_recursive_helper(arr,key,l,r):
    if (r >= l):
        ...
        if key < arr[mid1]:
            ...
            return ternary_search_recursive_helper(mid1 + 1,
                                 mid2 - 1, key, arr)
    return -1
...
def main():
    ...
    searches = [native_search, linear_search, binary_search_iterative,binary_search_iterative_better,binary_search_recursive,binary_search_randomized,ternary_search_recursive,interpolation_search,jump_search,exponential_search,fibonacci_search]
    trials = 1000
